...
class MedicalProduct(models.Model):
    ...
    active_ingredients = models.TextField(blank=True, null=True, db_column="active_ingredients")
    search_synonyms = models.TextField(blank=True, null=True, db_column="search_synonyms")
