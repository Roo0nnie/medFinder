...
export interface FileUploadProps {
	...
	onFileRemove?: () => void
	/** Duration in ms for upload simulation. Default 2000; 0 skips animation and calls success immediately. */
	uploadDelay?: number
...
export default function FileUpload({
	...
	const simulateUpload = useCallback(
		(uploadingFile: File) => {
			...
			const tickMs = Math.max(1, uploadDelay / (100 / UPLOAD_STEP_SIZE))
	...
	const handleFileSelect = useCallback(
		...
		[simulateUpload, validateFileSize, validateFileType, validateFile, handleError, onUploadSuccess, uploadDelay]
	)
