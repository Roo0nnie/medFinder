...
type DropdownMenuTriggerProps = Omit<MenuPrimitive.Trigger.Props, "render"> & {
	children: React.ReactElement
	asChild?: boolean
}

function DropdownMenuTrigger({ children, asChild: _asChild, ...props }: DropdownMenuTriggerProps) {
	return (
