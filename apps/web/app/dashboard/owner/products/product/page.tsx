...
export default function OwnerProductsTabPage() {
				...
				<CardContent className="space-y-4 p-4 sm:p-6">
					...
					<p className="text-muted-foreground text-sm">
						{editing
							...
							: "Fill in product details and set initial inventory. Name, Category, Unit, and Pharmacy are required. After creating a product, click Edit to add variants (sizes/volumes)."}
					</p>
