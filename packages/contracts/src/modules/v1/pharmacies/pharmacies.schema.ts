...
const basePharmacySchema = z.object({
	...
	certificateStatus: z.enum(["pending", "approved", "rejected"]).optional(),
	certificateSubmittedAt: z.union([z.date(), z.string()]).optional().nullable(),
	certificateReviewedAt: z.union([z.date(), z.string()]).optional().nullable(),
