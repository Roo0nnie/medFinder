...
**Scope (this monorepo):** Apply this skill when working on the **Next.js frontend** (`apps/web/`). The backend in this repo is **Django** (`apps/backend/`); these rules do not apply to Python/Django code. Use this document for React components, Next.js pages, API routes (Next.js), data fetching, and client/server component patterns in `apps/web/` only.
